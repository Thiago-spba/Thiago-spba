...
- Herança, Polimorfismo, Interfaces e Lambda
- Coleções e Stream API em Java
- Debugging e Tratamento de Exceções
- Gerenciando Dependências com Maven e Gradle
- Introdução ao Spring Boot
- API REST com Spring Web e Swagger
- Spring Security: Segurança em APIs REST
- Design Patterns com Java e Spring (GoF)
...
- Oracle Cloud Infrastructure: Deploy na Nuvem
...
<details>
<summary><b>🐧 DevOps & Linux (4 certificados)</b></summary>

- Linux: Gerenciamento de Arquivos e Processos
- Linux: Scripts de Monitoramento
- DevOps: Conceitos e Scripts no Linux CLI
- Redes: Conceitos e Projetos com VLANs
